...
\index{Camera@{Camera}!Camera@{Camera}}
\subsubsection[{\texorpdfstring{Camera(string intrinsic\+File\+Path)}{Camera(string intrinsicFilePath)}}]{\setlength{\rightskip}{0pt plus 5cm}Camera\+::\+Camera (
...
\subsubsection[{\texorpdfstring{calibrate(vector$<$ string $>$ image\+List, int board\+Width, int board\+Height)}{calibrate(vector< string > imageList, int boardWidth, int boardHeight)}}]{\setlength{\rightskip}{0pt plus 5cm}void Camera\+::calibrate (
\begin{DoxyParamCaption}
...
\subsubsection[{\texorpdfstring{get\+Camera\+Matrix()}{getCameraMatrix()}}]{\setlength{\rightskip}{0pt plus 5cm}Mat Camera\+::get\+Camera\+Matrix (
\begin{DoxyParamCaption}
{}
\end{DoxyParamCaption}
...
\subsubsection[{\texorpdfstring{get\+Dist\+Vector()}{getDistVector()}}]{\setlength{\rightskip}{0pt plus 5cm}Mat Camera\+::get\+Dist\+Vector (
\begin{DoxyParamCaption}
{}
\end{DoxyParamCaption}
...
\subsubsection[{\texorpdfstring{save\+Calibration(string intrinsic\+File\+Path)}{saveCalibration(string intrinsicFilePath)}}]{\setlength{\rightskip}{0pt plus 5cm}bool Camera\+::save\+Calibration (
\begin{DoxyParamCaption}
\item[{string}]{intrinsic\+File\+Path}
\end{DoxyParamCaption}
...
\subsubsection[{\texorpdfstring{set\+Camera\+Matrix(\+Mat \&\+K)}{setCameraMatrix(Mat &K)}}]{\setlength{\rightskip}{0pt plus 5cm}void Camera\+::set\+Camera\+Matrix (
\begin{DoxyParamCaption}
\item[{Mat \&}]{K}
\end{DoxyParamCaption}
...
\subsubsection[{\texorpdfstring{set\+Dist\+Coefficients(\+Mat \&\+Dist)}{setDistCoefficients(Mat &Dist)}}]{\setlength{\rightskip}{0pt plus 5cm}void Camera\+::set\+Dist\+Coefficients (
\begin{DoxyParamCaption}
\item[{Mat \&}]{Dist}
\end{DoxyParamCaption}
...
\subsubsection[{\texorpdfstring{undistort\+Image(\+Mat image)}{undistortImage(Mat image)}}]{\setlength{\rightskip}{0pt plus 5cm}Mat Camera\+::undistort\+Image (
\begin{DoxyParamCaption}
\item[{Mat}]{image}
\end{DoxyParamCaption}
